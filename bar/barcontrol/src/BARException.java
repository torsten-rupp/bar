...
class BARException extends Exception
{
  ...
  public final static int BIND_FAIL = 19;
  public final static int CONNECT_FAIL = 20;
  public final static int DISCONNECTED = 21;
  public final static int TOO_MANY_CONNECTIONS = 22;
  public final static int NO_LOGIN_NAME = 23;
  public final static int NO_LOGIN_PASSWORD = 24;
  public final static int NETWORK_SEND = 25;
  public final static int NETWORK_RECEIVE = 26;
  public final static int NETWORK_EXECUTE_FAIL = 27;
  public final static int NETWORK_TIMEOUT_SEND = 28;
  public final static int NETWORK_TIMEOUT_RECEIVE = 29;
  public final static int NO_RESPONSE = 30;
  public final static int INVALID_RESPONSE = 31;
  public final static int INIT_TLS = 32;
  public final static int NO_TLS_CA = 33;
  public final static int NO_TLS_CERTIFICATE = 34;
  public final static int NO_TLS_KEY = 35;
  public final static int INVALID_TLS_CA = 36;
  public final static int INVALID_TLS_CERTIFICATE = 37;
  public final static int TLS_CERTIFICATE_EXPIRED = 38;
  public final static int TLS_CERTIFICATE_NOT_ACTIVE = 39;
  public final static int TLS_HANDSHAKE = 40;
  public final static int INVALID_SSH_SPECIFIER = 41;
  public final static int NO_SSH_PUBLIC_KEY = 42;
  public final static int NO_SSH_PRIVATE_KEY = 43;
  public final static int NO_SSH_PASSWORD = 44;
  public final static int INVALID_SSH_PASSWORD = 45;
  public final static int INVALID_SSH_PRIVATE_KEY = 46;
  public final static int SSH_SESSION_FAIL = 47;
  public final static int SSH_AUTHENTICATION = 48;
  public final static int SSH = 49;
  public final static int JOB_ALREADY_EXISTS = 50;
  public final static int JOB_RUNNING = 51;
  public final static int CREATE_JOB = 52;
  public final static int DELETE_JOB = 53;
  public final static int RENAME_JOB = 54;
  public final static int INIT_STORAGE = 55;
  public final static int NO_STORAGE_NAME = 56;
  public final static int INVALID_STORAGE = 57;
  public final static int INVALID_FTP_SPECIFIER = 58;
  public final static int FTP_SESSION_FAIL = 59;
  public final static int NO_FTP_PASSWORD = 60;
  public final static int INVALID_FTP_PASSWORD = 61;
  public final static int FTP_AUTHENTICATION = 62;
  public final static int FTP_GET_SIZE = 63;
  public final static int INVALID_WEBDAV_SPECIFIER = 64;
  public final static int WEBDAV_SESSION_FAIL = 65;
  public final static int NO_WEBDAV_PASSWORD = 66;
  public final static int INVALID_WEBDAV_PASSWORD = 67;
  public final static int WEBDAV_AUTHENTICATION = 68;
  public final static int WEBDAV_BAD_REQUEST = 69;
  public final static int WEBDAV_GET_SIZE = 70;
  public final static int WEBDAV_UPLOAD = 71;
  public final static int WEBDAV_DOWNLOAD = 72;
  public final static int WEBDAV_FAIL = 73;
  public final static int INIT_COMPRESS = 74;
  public final static int INIT_DECOMPRESS = 75;
  public final static int DEFLATE_FAIL = 76;
  public final static int INFLATE_FAIL = 77;
  public final static int COMPRESS_EOF = 78;
  public final static int DELTA_SOURCE_NOT_FOUND = 79;
  public final static int INVALID_COMPRESS_ALGORITHM = 80;
  public final static int UNKNOWN_COMPRESS_ALGORITHM = 81;
  public final static int COMPRESS_ALGORITHM_NOT_SUPPORTED = 82;
  public final static int UNSUPPORTED_BLOCK_LENGTH = 83;
  public final static int INIT_CRYPT = 84;
  public final static int NO_DECRYPT_KEY = 85;
  public final static int NO_CRYPT_PASSWORD = 86;
  public final static int INVALID_CRYPT_PASSWORD = 87;
  public final static int CRYPT_PASSWORDS_MISMATCH = 88;
  public final static int INIT_CIPHER = 89;
  public final static int ENCRYPT_FAIL = 90;
  public final static int DECRYPT_FAIL = 91;
  public final static int CREATE_KEY_FAIL = 92;
  public final static int INVALID_ENCODING = 93;
  public final static int INIT_KEY = 94;
  public final static int KEY_NOT_FOUND = 95;
  public final static int READ_KEY_FAIL = 96;
  public final static int INVALID_KEY = 97;
  public final static int INVALID_KEY_LENGTH = 98;
  public final static int INVALID_BLOCK_LENGTH_ = 99;
  public final static int INVALID_SALT_LENGTH = 100;
  public final static int NO_PUBLIC_CRYPT_KEY = 101;
  public final static int NO_PRIVATE_CRYPT_KEY = 102;
  public final static int NOT_A_PUBLIC_CRYPT_KEY = 103;
  public final static int NOT_A_PRIVATE_CRYPT_KEY = 104;
  public final static int NO_PUBLIC_SIGNATURE_KEY = 105;
  public final static int NO_PRIVATE_SIGNATURE_KEY = 106;
  public final static int NOT_A_PUBLIC_SIGNATURE_KEY = 107;
  public final static int NOT_A_PRIVATE_SIGNATURE_KEY = 108;
  public final static int KEY_ENCRYPT_FAIL = 109;
  public final static int KEY_DECRYPT_FAIL = 110;
  public final static int WRONG_PRIVATE_KEY = 111;
  public final static int INVALID_CRYPT_ALGORITHM = 112;
  public final static int UNKNOWN_CRYPT_ALGORITHM = 113;
  public final static int INIT_HASH = 114;
  public final static int INVALID_HASH_ALGORITHM = 115;
  public final static int UNKNOWN_HASH_ALGORITHM = 116;
  public final static int INIT_MAC = 117;
  public final static int INVALID_MAC_ALGORITHM = 118;
  public final static int UNKNOWN_MAC_ALGORITHM = 119;
  public final static int NO_FILE_NAME = 120;
  public final static int CREATE_FILE = 121;
  public final static int OPEN_FILE = 122;
  public final static int CREATE_DIRECTORY = 123;
  public final static int IO = 124;
  public final static int READ_FILE = 125;
  public final static int END_OF_FILE = 126;
  public final static int WRITE_FILE = 127;
  public final static int DELETE_FILE = 128;
  public final static int OPEN_DIRECTORY = 129;
  public final static int READ_DIRECTORY = 130;
  public final static int FILE_EXISTS_ = 131;
  public final static int FILE_NOT_FOUND_ = 132;
  public final static int FILE_ACCESS_DENIED = 133;
  public final static int NOT_A_DIRECTORY = 134;
  public final static int END_OF_DIRECTORY = 135;
  public final static int INIT_FILE_NOTIFY = 136;
  public final static int INSUFFICIENT_FILE_NOTIFY = 137;
  public final static int OPTICAL_DISK_NOT_FOUND = 138;
  public final static int OPEN_OPTICAL_DISK = 139;
  public final static int OPEN_ISO9660_FILE = 140;
  public final static int NO_DEVICE_NAME = 141;
  public final static int OPEN_DEVICE = 142;
  public final static int INVALID_DEVICE_BLOCK_SIZE = 143;
  public final static int READ_DEVICE = 144;
  public final static int WRITE_DEVICE = 145;
  public final static int PARSE_DEVICE_LIST = 146;
  public final static int MOUNT = 147;
  public final static int UMOUNT = 148;
  public final static int NO_ARCHIVE_FILE_NAME = 149;
  public final static int NOT_AN_ARCHIVE_FILE = 150;
  public final static int ARCHIVE_NOT_FOUND = 151;
  public final static int END_OF_ARCHIVE = 152;
  public final static int NO_META_ENTRY = 153;
  public final static int NO_FILE_ENTRY = 154;
  public final static int NO_FILE_DATA = 155;
  public final static int NO_DIRECTORY_ENTRY = 156;
  public final static int NO_LINK_ENTRY = 157;
  public final static int NO_HARDLINK_ENTRY = 158;
  public final static int NO_SPECIAL_ENTRY = 159;
  public final static int NO_IMAGE_ENTRY = 160;
  public final static int NO_IMAGE_DATA = 161;
  public final static int END_OF_DATA = 162;
  public final static int INCOMPLETE_ARCHIVE = 163;
  public final static int INSUFFICIENT_SPLIT_NUMBERS = 164;
  public final static int CRC_ = 165;
  public final static int ENTRY_NOT_FOUND = 166;
  public final static int ENTRY_INCOMPLETE = 167;
  public final static int WRONG_ENTRY_TYPE = 168;
  public final static int ENTRIES_DIFFER = 169;
  public final static int CORRUPT_DATA = 170;
  public final static int INVALID_CHUNK_SIZE = 171;
  public final static int UNKNOWN_CHUNK = 172;
  public final static int INVALID_SIGNATURE = 173;
  public final static int NOT_AN_INCREMENTAL_FILE = 174;
  public final static int WRONG_INCREMENTAL_FILE_VERSION = 175;
  public final static int CORRUPT_INCREMENTAL_FILE = 176;
  public final static int INVALID_DEVICE_SPECIFIER = 177;
  public final static int LOAD_VOLUME_FAIL = 178;
  public final static int PARSE_COMMAND = 179;
  public final static int EXPAND_TEMPLATE = 180;
  public final static int FORK_FAIL = 181;
  public final static int IO_REDIRECT_FAIL = 182;
  public final static int EXEC_FAIL = 183;
  public final static int EXEC_TERMINATE = 184;
  public final static int PARSE = 185;
  public final static int PARSE_DATE = 186;
  public final static int PARSE_TIME = 187;
  public final static int PARSE_WEEKDAYS = 188;
  public final static int PARSE_MAINTENANCE = 189;
  public final static int PARSE_SCHEDULE = 190;
  public final static int UNKNOWN_COMMAND = 191;
  public final static int EXPECTED_PARAMETER = 192;
  public final static int UNKNOWN_VALUE = 193;
  public final static int INVALID_VALUE = 194;
  public final static int DEPRECATED_OR_IGNORED_VALUE = 195;
  public final static int AUTHORIZATION = 196;
  public final static int JOB_NOT_FOUND = 197;
  public final static int SCHEDULE_NOT_FOUND = 198;
  public final static int PERSISTENCE_ID_NOT_FOUND = 199;
  public final static int MAINTENANCE_ID_NOT_FOUND = 200;
  public final static int SERVER_ID_NOT_FOUND = 201;
  public final static int ENTRY_ID_NOT_FOUND = 202;
  public final static int PATTERN_ID_NOT_FOUND = 203;
  public final static int MOUNT_ID_NOT_FOUND = 204;
  public final static int DELTA_SOURCE_ID_NOT_FOUND = 205;
  public final static int DATABASE = 206;
  public final static int DATABASE_EXISTS = 207;
  public final static int DATABASE_VERSION_UNKNOWN = 208;
  public final static int DATABASE_MISSING_TABLE = 209;
  public final static int DATABASE_MISSING_COLUMN = 210;
  public final static int DATABASE_OBSOLETE_TABLE = 211;
  public final static int DATABASE_OBSOLETE_COLUMN = 212;
  public final static int DATABASE_TYPE_MISMATCH = 213;
  public final static int DATABASE_CREATE_INDEX = 214;
  public final static int DATABASE_INDEX_NOT_FOUND = 215;
  public final static int DATABASE_INDEX_NOT_READY = 216;
  public final static int DATABASE_INVALID_INDEX = 217;
  public final static int DATABASE_PARSE_ID = 218;
  public final static int DATABASE_TIMEOUT = 219;
  public final static int MASTER_DISCONNECTED = 220;
  public final static int SLAVE_DISCONNECTED = 221;
  public final static int NOT_PAIRED = 222;
  public final static int NOT_A_SLAVE = 223;
  public final static int TESTCODE = 224;
  public final static int UNKNOWN = 225;
  ...
  public static String getText(int errorCode, int errno, String errorData)
  {
    ...
    switch (errorCode)
    {
      ...
      case HOST_NOT_FOUND:
        ...
        break;
      case BIND_FAIL:
        stringSet(errorText,sizeof(errorText),BARControl.tr("bind fail"));
        if (!stringIsEmpty(errorData))
        {
          stringFormatAppend(errorText,sizeof(errorText),": %s",errorData);
        }

...
Architecture: any
Build-Depends: autogen, debhelper (>= 4.1.16), default-jdk, gcc, g++, libc6, libc6-dev, binutils, pkg-config, libssl-dev, m4, openssl, subversion, tcl, unzip, wget, bc, e2fsprogs
Files:

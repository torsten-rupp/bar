 ...
 *
 * RCS: @(#) $Id: tclScan_ext.c,v 1.1 2007-11-24 09:49:32 torsten Exp $
 */
 ...
 */
        ...
        /* ARGSUSED */
int
Tcl_ExtendedScanObjCmd(dummy, interp, objc, objv)
    ...
    Tcl_Obj *CONST objv[];      /* Argument objects. */
{
    ...
    while (*format != '\0') {
        ...
        switch (op) {
            ...
            case 'w':
                /*
                 * Scan a word up to width characters or whitespace; handke " and '
                 */
                ...
                if (!(flags & SCAN_SUPPRESS)) {
                    objPtr = Tcl_NewStringObj(word, wordend-word);
                    Tcl_IncrRefCount(objPtr);
                    objs[objIndex++] = objPtr;
                }
                string = end;

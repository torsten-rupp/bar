...
LOCAL bool StorageSFTP_equalNames(const StorageSpecifier *storageSpecifier1,
...
LOCAL Errors StorageSFTP_open(StorageHandle *storageHandle, ConstString archiveName)
{
  Errors error;

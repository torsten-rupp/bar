                     ...
                     )
{
  ...
  ProgressInfo_reset(progressInfo,maxSteps);
}
...
void ProgressInfo_reset(ProgressInfo *progressInfo, uint64 maxSteps)
{
  String text;
...
//fprintf(stderr,"%s:%d: _\n",__FILE__,__LINE__); asm("int3");
    ...
    estimatedTotalTime = stepTime*progressInfo->maxSteps;

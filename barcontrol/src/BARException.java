...
class BARException extends Exception
{
  ...
  public final static int DATABASE_CONNECTION_LOST = 207;
  public final static int DATABASE_EXISTS = 208;
  public final static int DATABASE_VERSION_UNKNOWN = 209;
  public final static int DATABASE_MISSING_TABLE = 210;
  public final static int DATABASE_MISSING_COLUMN = 211;
  public final static int DATABASE_OBSOLETE_TABLE = 212;
  public final static int DATABASE_OBSOLETE_COLUMN = 213;
  public final static int DATABASE_BUSY = 214;
  public final static int DATABASE_INTERRUPTED = 215;
  public final static int DATABASE_TYPE_MISMATCH = 216;
  public final static int DATABASE_CREATE_INDEX = 217;
  public final static int DATABASE_INDEX_NOT_FOUND = 218;
  public final static int DATABASE_INDEX_NOT_READY = 219;
  public final static int DATABASE_INVALID_INDEX = 220;
  public final static int DATABASE_PARSE_ID = 221;
  public final static int DATABASE_TIMEOUT = 222;
  public final static int MASTER_DISCONNECTED = 223;
  public final static int SLAVE_DISCONNECTED = 224;
  public final static int NOT_PAIRED = 225;
  public final static int NOT_A_SLAVE = 226;
  public final static int TESTCODE = 227;
  public final static int UNKNOWN = 228;
  ...
  public static String getText(int errorCode, int errno, String errorData)
  {
    ...
    switch (errorCode)
    {
      ...
      case DATABASE_CONNECTION_LOST:
        stringSet(errorText,sizeof(errorText),BARControl.tr("datbase connection lost"));
        break;
      ...
      case DATABASE_OBSOLETE_COLUMN:
        ...
        break;
      case DATABASE_BUSY:
        stringSet(errorText,sizeof(errorText),BARControl.tr("database busy"));
        break;
      case DATABASE_INTERRUPTED:
        stringSet(errorText,sizeof(errorText),BARControl.tr("database operation interupted"));
        break;
